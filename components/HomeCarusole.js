      ...
      <div className="relative text-white text-[20px] w-full mx-auto">
        ...
        >
          {[...Array(5)].map((Number, i) => (
            <div className="" key={i}>
              <img
                src="https://backgrounds.wetransfer.net/creator/wepresent-2301/2302-p9/wp1-fs/1_3FUE2B/img.79eb42c9053f21f10f21.jpg"
                className="aspect-[16/10] md:aspect-auto object-cover h-screen w-full"
              />
